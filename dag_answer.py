...
with models.DAG('bq_copy_us_to_eu_01', 
    ...
    for record in all_records:
        ...
        GCS_to_GCS = 'what operator do yo use to transfer files from GCS to GCS? hint: check your plugins folder in the DAG bucket'

        GCS_to_BQ = 'what opertor do you use to transfer files from GCS to BQ?'
